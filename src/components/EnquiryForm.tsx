        ...
        <form onSubmit={handleSubmit} className={`space-y-4 ${className}`}>
            <div>
                ...
                <input
                    ...
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-tapoutsPurple focus:border-transparent outline-none transition-all text-sm !text-gray-900 placeholder:text-gray-500"
            ...
            <div>
                ...
                <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-tapoutsPurple focus:border-transparent outline-none transition-all text-sm resize-none !text-gray-900 placeholder:text-gray-500"
