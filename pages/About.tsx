        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 text-center">
          ...
          >
            <h1 className="text-6xl md:text-8xl font-black mb-6">
              <span className="text-white font-brand italic tracking-wide">tapouts</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <h3 className="text-2xl md:text-4xl font-bold leading-tight">
              <span className="font-brand italic text-tapoutsPurple">tapouts</span> are omnichannel customer journeys touchpoints creating new experiences & enabling growth.
            </h3>
          </div>
        </div>
      </div>
