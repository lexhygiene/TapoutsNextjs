...
import { CheckCircle, Shield, Zap, BarChart, Server, Clock, Globe, ArrowRight, Play, Star } from 'lucide-react';
        ...
        <div className="bg-white font-sans">
            ...
            <div className="relative bg-[#0a0f2c] text-white overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 md:py-32">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <div className="mb-6">
                                <span className="font-brand italic text-5xl md:text-6xl tracking-wide text-white">tapouts</span>
                            </div>
            ...
            <div className="py-16 text-center max-w-4xl mx-auto px-4">
                <div className="mb-4 flex justify-center">
                    <span className="font-brand italic text-3xl text-black">tapouts</span>
                </div>
            ...
            <div className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-8 text-center">
                        {[
                            { icon: <Globe className="w-8 h-8" />, title: "Site Health Audit" },
                            { icon: <Server className="w-8 h-8" />, title: "Monitoring & Backups" },
                            { icon: <Shield className="w-8 h-8" />, title: "Patch & Protect" },
                            { icon: <Clock className="w-8 h-8" />, title: "Support & Reporting" },
                            { icon: <BarChart className="w-8 h-8" />, title: "Iterate on Data" }
                        ].map((step, idx) => (
                            <div key={idx} className="relative group">
                                <div className="w-16 h-16 mx-auto bg-white rounded-full flex items-center justify-center mb-4 shadow-lg border border-gray-100 group-hover:border-red-600 transition-colors">
                                    <div className="text-gray-600 group-hover:text-red-600 transition-colors">{step.icon}</div>
                                </div>
            ...
            <div className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Amit Parmar</h3>
                    <p className="text-gray-500 text-sm uppercase tracking-widest mb-8">General Manager Sales & Marketing, Rolls Royce India</p>

                    <div className="flex justify-center gap-12 mt-12">
                        <div className="text-center opacity-50 hover:opacity-100 transition-opacity cursor-pointer">
                            <h4 className="font-bold text-gray-900">Franky DeSouza</h4>
                            <p className="text-xs text-gray-500">Head of Marketing, Oysters Beach</p>
                        </div>
                        <div className="text-center opacity-50 hover:opacity-100 transition-opacity cursor-pointer">
                            <h4 className="font-bold text-gray-900">Ian Harris</h4>
                            <p className="text-xs text-gray-500">Founder, Cost Assist UK</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-black py-12 text-center">
                <span className="font-brand italic text-5xl text-white tracking-wider">tapouts</span>
