      ...
      <div className="bg-[#0a0f2c] text-white py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            From strategic planning to flawless execution, <span className="font-brand italic text-white">tapouts</span> provides the end-to-end digital solutions you need to dominate your market.
          </p>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-nexusDark p-8 rounded-xl shadow-sm flex flex-col items-center justify-center text-center text-white">
              ...
              <Button variant="gold" size="sm">Get in Touch</Button>
            </div>
          </div>
        </div>
